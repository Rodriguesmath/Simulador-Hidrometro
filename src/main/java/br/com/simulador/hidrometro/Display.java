...
public class Display {
    ...
    private BufferedImage gerarImagemAnalogica(float total_m3) {
        ...
        int circuloRaio = 16;
        float fluxoValor = (total_m3 * 100000f);
        float rotationAngle = (fluxoValor - (int)fluxoValor) * 360;
        g.setColor(Color.BLACK);
        g.fillArc(circuloCentralX - circuloRaio, circuloCentralY - circuloRaio, circuloRaio * 2, circuloRaio * 2, (int)(0 - rotationAngle), 90);
        g.fillArc(circuloCentralX - circuloRaio, circuloCentralY - circuloRaio, circuloRaio * 2, circuloRaio * 2, (int)(180 - rotationAngle), 90);
        g.setColor(Color.WHITE);
        g.fillArc(circuloCentralX - circuloRaio, circuloCentralY - circuloRaio, circuloRaio * 2, circuloRaio * 2, (int)(90 - rotationAngle), 90);
        g.fillArc(circuloCentralX - circuloRaio, circuloCentralY - circuloRaio, circuloRaio * 2, circuloRaio * 2, (int)(270 - rotationAngle), 90);
        g.setColor(Color.BLACK);
        g.setStroke(new BasicStroke(1.5f));
    ...
    public void exibirImagem(float total_m3) {
        BufferedImage img = gerarImagemAnalogica(total_m3);
