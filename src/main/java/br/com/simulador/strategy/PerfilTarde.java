...
/**
 * Estratégia de consumo para o período da tarde.
 * Os parâmetros são injetados via construtor.
 */
public class PerfilTarde implements PerfilDeConsumoStrategy {
     ...
     */
    public PerfilTarde(float minVelocidade, float maxVelocidade, int horaInicio, int horaFim) {
