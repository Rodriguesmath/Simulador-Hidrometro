...
/**
 * Estratégia de consumo para o período da madrugada.
 * Os parâmetros são injetados via construtor.
 */
public class PerfilMadrugada implements PerfilDeConsumoStrategy {
     ...
     */
    public PerfilMadrugada(float minVelocidade, float maxVelocidade, int horaInicio, int horaFim) {
