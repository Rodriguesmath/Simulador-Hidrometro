...
/**
 * Estratégia de consumo para o período da manhã.
 * Os parâmetros são injetados via construtor.
 */
public class PerfilManha implements PerfilDeConsumoStrategy {
     ...
     */
    public PerfilManha(float minVelocidade, float maxVelocidade, int horaInicio, int horaFim) {
